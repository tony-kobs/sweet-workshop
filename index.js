import{r as e}from"./assets/rolldown-runtime-QTnfLwEv.js";import{a as t,c as n,i as r,n as i,o as a,r as o,s as ee,t as te}from"./assets/vendor-BGcUWCvz.js";(function(){let e=document.createElement(`link`).relList;if(e&&e.supports&&e.supports(`modulepreload`))return;for(let e of document.querySelectorAll(`link[rel="modulepreload"]`))n(e);new MutationObserver(e=>{for(let t of e)if(t.type===`childList`)for(let e of t.addedNodes)e.tagName===`LINK`&&e.rel===`modulepreload`&&n(e)}).observe(document,{childList:!0,subtree:!0});function t(e){let t={};return e.integrity&&(t.integrity=e.integrity),e.referrerPolicy&&(t.referrerPolicy=e.referrerPolicy),e.crossOrigin===`use-credentials`?t.credentials=`include`:e.crossOrigin===`anonymous`?t.credentials=`omit`:t.credentials=`same-origin`,t}function n(e){if(e.ep)return;e.ep=!0;let n=t(e);fetch(e.href,n)}})(),document.addEventListener(`DOMContentLoaded`,()=>{let e=document.getElementById(`burgerToggle`),t=document.getElementById(`burgerClose`),n=document.getElementById(`menu`),r=document.body;function i(){n.classList.add(`open`),r.classList.add(`no-scroll`)}function a(){n.classList.remove(`open`),r.classList.remove(`no-scroll`)}n&&(e&&e.addEventListener(`click`,i),t&&t.addEventListener(`click`,a),n.querySelectorAll(`.nav-link, .btn-action`).forEach(e=>{e.addEventListener(`click`,a)}),document.querySelectorAll(`.logo-link`).forEach(e=>{e.addEventListener(`click`,a)}),window.addEventListener(`keydown`,e=>{e.key===`Escape`&&a()}))});var ne=`https://deserts-store.b.goit.study/api`,re=`/desserts/{id}`,s=`/desserts`,c=`/categories`,l=`/orders`,u=`/feedbacks`,d=ee.create({baseURL:ne,headers:{"Content-Type":`application/json`}}),f=(e={})=>d.get(s,{params:e}),ie=e=>d.get(re.replace(`{id}`,e)),ae=()=>d.get(c),oe=e=>d.post(l,e),se=()=>d.get(u),p=`/sweet-deploy-team/assets/icons-CnkChGia.svg`,ce=5,m=24,h={768:{slidesPerView:2,spaceBetween:m},1440:{slidesPerView:3,spaceBetween:m}};function g(e){if(!e?.pagination?.el)return;let t=[...e.pagination.el.querySelectorAll(`.swiper-pagination-bullet`)],n=e.realIndex,r=Math.floor(ce/2),i=n-r,a=n+r;i<0&&(a+=Math.abs(i),i=0),a>=t.length&&(i=Math.max(0,i-(a-t.length+1)),a=t.length-1),t.forEach((e,t)=>{let r=Math.abs(t-n);if(e.classList.remove(`bullet-active`,`bullet-near`,`bullet-far`),t<i||t>a){e.style.display=`none`;return}e.style.display=`inline-block`,r===0?e.classList.add(`bullet-active`):r===1?e.classList.add(`bullet-near`):e.classList.add(`bullet-far`)})}function _(e={}){return{init(t){g(t),e?.init?.(t)},slideChange(t){g(t),e?.slideChange?.(t)}}}function v(e,i={}){return new n(e,{modules:[t,r,a],slidesPerView:1,spaceBetween:20,grabCursor:!0,watchOverflow:!0,pagination:{clickable:!0},...i})}function y(e){return v(e,{observer:!0,observeParents:!0,resizeObserver:!0,navigation:{nextEl:`.popular-nav-btn-next`,prevEl:`.popular-nav-btn-prev`},pagination:{el:`.popular-pagination`,clickable:!0},breakpoints:h,on:_()})}function b(e,t={}){return v(e,{keyboard:{enabled:!0,onlyInViewport:!0,pageUpDown:!1},navigation:{nextEl:`.feedback-arrow-next, .feedback-mobile-arrow-next`,prevEl:`.feedback-arrow-prev, .feedback-mobile-arrow-prev`},pagination:{el:`.feedback-pagination`,clickable:!0},breakpoints:{320:{slidesPerView:1,spaceBetween:m},...h},on:_(t)})}function le(e){return v(e,{slidesPerView:2,slidesPerGroup:2,spaceBetween:m,navigation:{nextEl:`.about-us-nav-btn-next`,prevEl:`.about-us-nav-btn-prev`},pagination:{el:`.about-us-pagination`,clickable:!0,dynamicBullets:!0}})}function x(e){e&&typeof e.destroy==`function`&&e.destroy(!0,!0)}var S=document.getElementById(`popular-products-list`);function ue(){let e=document.querySelector(`.popular-swiper`);e&&y(e)}async function C(){if(S)try{let e=await f({type:`popular`}),t=e.data.desserts||e.data;if(!t||t.length<3){console.warn(`Отримано менше 3-х популярних товарів`);return}S.innerHTML=t.map(({_id:e,image:t,category:n,name:r,description:i,price:a})=>`
...
`,n.querySelector(`.order-btn`).addEventListener(`click`,()=>{i(),z(e)})}catch{n.innerHTML=`
    ...
    `}}var H=null,U=8,W=1,G=`all`,K=0,q=document.getElementById(`dessert-list`),J=document.getElementById(`load-more-btn`),Y=document.getElementById(`category-desktop`),pe=document.getElementById(`category-mobile`);function me(e){let t=e.map(({_id:e,image:t,category:n,name:r,description:i,price:a})=>`
  ...
  `).join(``);q.insertAdjacentHTML(`beforeend`,t)}function he(e){Y.innerHTML=[`<label class="category-btn">
      ...
      <label class="category-btn">
        ...
        ${t}
      </label>`)].join(``),H=new fe(pe,{placeholder:`Оберіть категорію`,options:[{value:`all`,label:`Всі десерти`,checked:!0},...e.map(({_id:e,name:t})=>({value:e,label:t}))],onChange:async e=>{G=e,await X(!0)}}),H.setValue(`all`)}async function X(e=!1){try{E(),e&&(q.innerHTML=``,W=1);let{data:t}=await f({page:W,limit:U,...G!==`all`&&{category:G}});K=t.totalItems,me(t.desserts);let n=W*U;J.classList.toggle(`load-more-hidden`,n>=K)}catch{k(`Не вдалося завантажити десерти`)}finally{D()}}J.addEventListener(`click`,async()=>{W+=1,await X()}),Y.addEventListener(`change`,async e=>{e.target.name===`category`&&(G=e.target.value,H&&H.setValue(G),await X(!0))}),document.addEventListener(`click`,e=>{let t=e.target.closest(`.dessert-modal-btn`);if(!t)return;let n=t.dataset.id;console.log(n),V(n)});async function Z(){try{E();let{data:e}=await ae();he(e),await X(),J.classList.remove(`load-more-hidden`)}catch(e){console.error(e),k(`Щось пішло не так. Спробуйте пізніше!`)}finally{D()}}Z();var ge=(e,t=200)=>{let n;return(...r)=>{clearTimeout(n),n=setTimeout(()=>{e(...r)},t)}};document.addEventListener(`DOMContentLoaded`,()=>{let e=document.querySelector(`.about-us-swiper`);if(!e)return;let t=null,n=()=>{t=le(e)},r=()=>{x(t),t=null},i=()=>{window.innerWidth<=768?r():t||n()};i(),window.addEventListener(`resize`,ge(i,150))});var _e=10,ve=1,Q=document.getElementById(`feedback-list`);function ye(e){Q.innerHTML=e.map(({_id:e,rate:t,author:n,description:r})=>`
      ...
      `).join(``)}function be(){x(window.feedbackSwiperInstance),window.feedbackSwiperInstance=null,window.feedbackSwiperInstance=b(`.feedback-slider-container`,{slideChange(e){let t=e.activeIndex>(e.previousIndex||0)?document.querySelectorAll(`.feedback-arrow-next, .feedback-mobile-arrow-next`):document.querySelectorAll(`.feedback-arrow-prev, .feedback-mobile-arrow-prev`);t.forEach(e=>e.classList.add(`is-active`)),setTimeout(()=>{t.forEach(e=>e.classList.remove(`is-active`))},200)}})}async function $(){try{E(),Q&&(Q.innerHTML=``);let e=document.querySelector(`.feedback-pagination`);e&&(e.innerHTML=``);let t=await se({page:Number(ve),limit:Number(_e)}),n=t?.data?.feedbacks||t?.feedbacks||t?.data||t;Array.isArray(n)&&n.length>0&&(ye(n),be())}catch(e){k(`Не вдалося завантажити відгуки клієнтів. Спробуйте пізніше. (${e?.response?.status||e?.status||e?.code||`Network Error`})`)}finally{D()}}document.addEventListener(`DOMContentLoaded`,()=>{let e=document.querySelector(`.feedback-section`)||document.querySelector(`#feedback-section`)||document.querySelector(`.feedback-slider-container`);if(!e){$();return}new IntersectionObserver((e,t)=>{e.forEach(e=>{e.isIntersecting&&($(),t.unobserve(e.target))})},{rootMargin:`300px`}).observe(e)});var xe=e(te(),1);function Se(){let e=document.getElementById(`faqAccordion`);if(!e)return console.warn(`FAQ акордеон: контейнер #faqAccordion не знайдено`),null;document.querySelectorAll(`.ac-trigger`).forEach(e=>{e.querySelector(`.faq-icon`)||e.insertAdjacentHTML(`beforeend`,`
