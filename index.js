import{r as e}from"./assets/rolldown-runtime-QTnfLwEv.js";import{a as t,c as n,i as r,n as i,o as a,r as o,s,t as c}from"./assets/vendor-BBxvFN2L.js";(function(){let e=document.createElement(`link`).relList;if(e&&e.supports&&e.supports(`modulepreload`))return;for(let e of document.querySelectorAll(`link[rel="modulepreload"]`))n(e);new MutationObserver(e=>{for(let t of e)if(t.type===`childList`)for(let e of t.addedNodes)e.tagName===`LINK`&&e.rel===`modulepreload`&&n(e)}).observe(document,{childList:!0,subtree:!0});function t(e){let t={};return e.integrity&&(t.integrity=e.integrity),e.referrerPolicy&&(t.referrerPolicy=e.referrerPolicy),e.crossOrigin===`use-credentials`?t.credentials=`include`:e.crossOrigin===`anonymous`?t.credentials=`omit`:t.credentials=`same-origin`,t}function n(e){if(e.ep)return;e.ep=!0;let n=t(e);fetch(e.href,n)}})(),document.addEventListener(`DOMContentLoaded`,()=>{let e=document.getElementById(`burgerToggle`),t=document.getElementById(`burgerClose`),n=document.getElementById(`menu`),r=document.body;function i(){n.classList.add(`open`),r.classList.add(`no-scroll`)}function a(){n.classList.remove(`open`),r.classList.remove(`no-scroll`)}n&&(e&&e.addEventListener(`click`,i),t&&t.addEventListener(`click`,a),n.querySelectorAll(`.nav-link, .btn-action`).forEach(e=>{e.addEventListener(`click`,a)}),document.querySelectorAll(`.logo-link`).forEach(e=>{e.addEventListener(`click`,a)}),window.addEventListener(`keydown`,e=>{e.key===`Escape`&&a()}))});var ee=`https://deserts-store.b.goit.study/api`,te=`/desserts/{id}`,l=`/desserts`,ne=`/categories`,u=`/orders`,d=`/feedbacks`,f=s.create({baseURL:ee,headers:{"Content-Type":`application/json`}}),p=(e={})=>f.get(l,{params:e}),m=e=>f.get(te.replace(`{id}`,e)),h=()=>f.get(ne),g=e=>f.post(u,e),_=()=>f.get(d),v=document.getElementById(`loader`),y=0;function b(){y+=1,v.classList.remove(`hidden`)}function x(){--y,y<=0&&(y=0,v.classList.add(`hidden`))}var S=e(a(),1);function C(e){S.default.success({title:`Успіх`,message:e,position:`topRight`})}function w(e){S.default.error({title:`Помилка`,message:e,position:`topRight`})}var T=`/sweet-deploy-team/assets/icons-CnkChGia.svg`,E=class{constructor(e,{options:t=[],placeholder:n=`Оберіть один...`,onChange:r}={}){this.container=e,this.options=t,this.placeholder=n,this.onChange=r,this.selected=null,this._render()}_render(){let e=document.createElement(`select`);this.container.appendChild(e),this._choices=new t(e,{choices:this.options.map(e=>({value:e.value,label:e.label,selected:e.value===`all`})),placeholder:!0,placeholderValue:this.placeholder,searchEnabled:!1,itemSelectText:``,shouldSort:!1,classNames:{containerOuter:[`choices`,`sel-wrap`],containerInner:[`choices__inner`,`sel-box`],list:[`choices__list`],listItems:[`choices__list--multiple`],listSingle:[`choices__list--single`],listDropdown:[`choices__list--dropdown`,`sel-dropdown`],item:[`choices__item`],itemSelectable:[`choices__item--selectable`],selectedState:[`is-selected`],placeholder:[`choices__placeholder`,`sel-placeholder`]}}),this.container.querySelector(`.choices__inner`).insertAdjacentHTML(`beforeend`,`<span class="sel-chevron" aria-hidden="true">
...
`,n.querySelector(`.order-btn`).addEventListener(`click`,()=>{i(),I(e)})}catch{n.innerHTML=`
  ...
  `).join(``);W.insertAdjacentHTML(`beforeend`,t)}function Y(e){K.innerHTML=[`<label class="category-btn">
      ...
      `).join(``)}function se(){window.feedbackSwiperInstance&&typeof window.feedbackSwiperInstance.destroy==`function`&&(window.feedbackSwiperInstance.destroy(!0,!0),window.feedbackSwiperInstance=null);let e=n||window.Swiper;e&&(window.feedbackSwiperInstance=new e(`.feedback-slider-container`,{modules:[o,i,r],slidesPerView:1,spaceBetween:20,allowTouchMove:!0,grabCursor:!0,autoHeight:!1,keyboard:{enabled:!0,onlyInViewport:!0,pageUpDown:!1},navigation:{nextEl:`.feedback-arrow-next, .feedback-mobile-arrow-next`,prevEl:`.feedback-arrow-prev, .feedback-mobile-arrow-prev`},pagination:{el:`.feedback-pagination`,clickable:!0},breakpoints:{320:{slidesPerView:1,spaceBetween:24},768:{slidesPerView:3,spaceBetween:24},1440:{slidesPerView:3,spaceBetween:24}},on:{paginationRender:function(e,t){if(t){let e=t.querySelectorAll(`.swiper-pagination-bullet`);if(e.length>Z)for(let t=Z;t<e.length;t++)e[t].remove()}}}}))}async function ce(){try{b(),Q&&(Q.innerHTML=``);let e=document.querySelector(`.feedback-pagination`);e&&(e.innerHTML=``);let t=await _({page:Number(ae),limit:Number(Z)}),n=t?.data?.feedbacks||t?.feedbacks||t?.data||t;Array.isArray(n)&&n.length>0&&(oe(n),se())}catch(e){w(`Не вдалося завантажити відгуки клієнтів. Спробуйте пізніше. (${e?.response?.status||e?.status||e?.code||`Network Error`})`)}finally{x()}}ce();var le=e(c(),1);function ue(){let e=document.getElementById(`faqAccordion`);if(!e)return console.warn(`FAQ акордеон: контейнер #faqAccordion не знайдено`),null;document.querySelectorAll(`.ac-trigger`).forEach(e=>{e.querySelector(`.faq-icon`)||e.insertAdjacentHTML(`beforeend`,`
      <svg class="faq-icon" width="32" height="32" viewBox="0 0 32 32">
        <use href="${T}#icon-keyboard_arrow_down"></use>
      </svg>
    `)});let t=new le.default(e,{duration:380,showMultiple:!1,collapse:!0,ariaEnabled:!0,onlyChildNodes:!0,openOnInit:[],elementClass:`ac`,triggerClass:`ac-trigger`,panelClass:`ac-panel`,activeClass:`is-active`});return console.log(`✅ FAQ акордеон успішно ініціалізовано`),t}var $=document.getElementById(`popular-products-list`);function de(){let e=document.querySelector(`.popular-swiper`);e&&new n(e,{modules:[o,i],observer:!0,observeParents:!0,resizeObserver:!0,slidesPerView:1,spaceBetween:20,grabCursor:!0,navigation:{nextEl:`.popular-nav-btn-next`,prevEl:`.popular-nav-btn-prev`},pagination:{el:`.popular-pagination`,clickable:!0},breakpoints:{768:{slidesPerView:2,spaceBetween:24},1440:{slidesPerView:3,spaceBetween:24}}})}async function fe(){if($)try{let e=await p({type:`popular`}),t=e.data.desserts||e.data;if(!t||t.length<3){console.warn(`Отримано менше 3-х популярних товарів`);return}$.innerHTML=t.map(({_id:e,image:t,category:n,name:r,description:i,price:a})=>`
        ...
        `).join(``),de()}catch(e){console.error(`Помилка при завантаженні популярних товарів:`,e)}}document.addEventListener(`DOMContentLoaded`,()=>{fe()}),ue();
